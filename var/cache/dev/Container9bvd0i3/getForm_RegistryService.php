...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\Type\\ArticleType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\ArticleType']) ? $this->services['AppBundle\Form\Type\ArticleType'] : $this->services['AppBundle\Form\Type\ArticleType'] = new \AppBundle\Form\Type\ArticleType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\CategoryType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\CategoryType']) ? $this->services['AppBundle\Form\Type\CategoryType'] : $this->services['AppBundle\Form\Type\CategoryType'] = new \AppBundle\Form\Type\CategoryType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\CommandeType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\CommandeType']) ? $this->services['AppBundle\Form\Type\CommandeType'] : $this->services['AppBundle\Form\Type\CommandeType'] = new \AppBundle\Form\Type\CommandeType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\PanierType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\PanierType']) ? $this->services['AppBundle\Form\Type\PanierType'] : $this->services['AppBundle\Form\Type\PanierType'] = new \AppBundle\Form\Type\PanierType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\UserType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\UserType']) ? $this->services['AppBundle\Form\Type\UserType'] : $this->services['AppBundle\Form\Type\UserType'] = new \AppBundle\Form\Type\UserType()) && false ?: '_'};
