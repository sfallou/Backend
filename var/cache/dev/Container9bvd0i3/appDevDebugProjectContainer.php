...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\form\\type\\articletype' => 'AppBundle\\Form\\Type\\ArticleType',
            'appbundle\\form\\type\\categorytype' => 'AppBundle\\Form\\Type\\CategoryType',
            'appbundle\\form\\type\\commandetype' => 'AppBundle\\Form\\Type\\CommandeType',
            'appbundle\\form\\type\\paniertype' => 'AppBundle\\Form\\Type\\PanierType',
            'appbundle\\form\\type\\usertype' => 'AppBundle\\Form\\Type\\UserType',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Form\\Type\\ArticleType' => 'getArticleTypeService.php',
            'AppBundle\\Form\\Type\\CategoryType' => 'getCategoryTypeService.php',
            'AppBundle\\Form\\Type\\CommandeType' => 'getCommandeTypeService.php',
            'AppBundle\\Form\\Type\\PanierType' => 'getPanierTypeService.php',
            'AppBundle\\Form\\Type\\UserType' => 'getUserTypeService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\Type\\ArticleType' => true,
            'AppBundle\\Form\\Type\\CategoryType' => true,
            'AppBundle\\Form\\Type\\CommandeType' => true,
            'AppBundle\\Form\\Type\\PanierType' => true,
            'AppBundle\\Form\\Type\\UserType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('J3zeUF-rov', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xva5Onju5B', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GpGxvImQvg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2+-WAJLoe3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'u657659556_api',
            'database_user' => 'u657659556_api',
            'database_password' => '60B0qADVhkeI',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'messagerbroadcaster@gmail.com',
            'mailer_password' => 'passerSMS',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'messagerbroadcaster@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'passerSMS',
